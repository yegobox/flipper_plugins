...
//         value: percentFormat(context).format(0.001), title: '',
//       ),
//       UserDetailData(
//         title: '',
//         // title:
...
//         value: usdWithSignFormat(context).format(81.45), title: '',
//       ),
//       UserDetailData(
//         title: '',
//         // title: GalleryLocalizations.of(context)
...
//         value: usdWithSignFormat(context).format(paidTotal), title: '',
//       ),
//       UserDetailData(
//         // title: GalleryLocalizations.of(context).rallyBillDetailAmountDue,
//         value: usdWithSignFormat(context).format(dueTotal), title: '',
//       ),
//     ];
//   }
...
//         value: usdWithSignFormat(context).format(capTotal), title: '',
//       ),
//       UserDetailData(
//         // title: GalleryLocalizations.of(context).rallyBudgetDetailAmountUsed,
//         value: usdWithSignFormat(context).format(usedTotal), title: '',
//       ),
//       UserDetailData(

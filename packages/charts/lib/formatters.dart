...
// DateFormat shortDateFormat(BuildContext context) => DateFormat.yMd(
//     // locale(context)
//     );

// /// Date formatter with year / month / day.
// DateFormat longDateFormat(BuildContext context) => DateFormat.yMMMMd(
//     // locale(context)
//     );
...
// DateFormat dateFormatMonthYear(BuildContext context) => DateFormat.yMMM(
//     // locale(context)
//     );
